...
String parameterToString(dynamic value) {
  ...
  if (value is LotteryStatus) {
    return LotteryStatusTypeTransformer().encode(value).toString();
  }
  if (value is PrizeGrade) {
    return PrizeGradeTypeTransformer().encode(value).toString();
  }
