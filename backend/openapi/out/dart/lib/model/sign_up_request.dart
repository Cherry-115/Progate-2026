...
class SignUpRequest {
  ...
  @override
  String toString() => 'SignUpRequest[displayName=$displayName, email=$email, password=$password]';
  ...
  static SignUpRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'displayName'), 'Required key "SignUpRequest[displayName]" is missing from JSON.');
        assert(json[r'displayName'] != null, 'Required key "SignUpRequest[displayName]" has a null value in JSON.');
